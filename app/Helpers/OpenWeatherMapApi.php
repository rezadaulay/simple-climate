...
class OpenWeatherMapApi{
	...
	public function getWeatherForecast($q, $params = null){
		$curl = curl_init();
		curl_setopt_array($curl, array(
		  CURLOPT_URL => 'http://api.openweathermap.org/data/2.5/forecast/daily?APPID='.$this->AppID.'&q='.$q.( !is_null($params)? '&'.$params : '' ),
